import sys  #handling the command line arguments,# Exiting the application
import pickle  #serializing and deserializing Python objects,used for loading a machine learning model from a file
import cv2  #capture video frames from a webcam or a video file , Image Processing and Visualization,Real-Time Processing
import os  #is used for operating system dependent functionalities, such as accessing and manipulating files and directories
import time  #Measuring Time Taken for Operations,Calculating Frame Rates
import multiprocessing  #handle video processing tasks in a separate thread, specifically in the VideoThread class
#Creating GUI Elements,Event Handling,Layout Management,File Dialogs,Graphics and Display
...
import numpy as np  #numerical computing and handling multi-dimensional arrays 
import pandas as pd #data manipulation and analysis ,Creating DataFrame objects 
import mediapipe as mp #pose estimation,detecthuman body landmarks in real-time video frames
...
# Opening the Machine learning Model by using pickle library
try:
...
#run video processing tasks in a separate thread (QThread) to ensure smooth and non-blocking real-time video processing
    ...
    def run(self):
        ...
        while self._run_flag:
            ...
            try:
                ...
                print(f"Error making recognitions: {e}")
...
class About(QWidget):
    def __init__(self):
        ...
        self.label_6.setText("Group members' names")
